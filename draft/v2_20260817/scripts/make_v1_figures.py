...
building-density-enabled W=500 m result and writes only into its containing version.
"""
...
def write_tables() -> None:
    rows = [
        ...
        ["Tier-1 exposure", MA["L_dense1_km"], MC["L_dense1_km"],
         percent(MC["L_dense1_km"], MA["L_dense1_km"]), "km"],
